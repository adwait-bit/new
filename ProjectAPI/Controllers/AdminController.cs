...
namespace ProjectAPI.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        [HttpPost("Adminlogin")]
        public async Task<IActionResult> AdminLogin( AdminModel adminModel, string emailid, string password)
        {
            string ar = await admin.AdminLogin(adminModel, emailid, password);
            return Ok(ar);
